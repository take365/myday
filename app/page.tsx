...
export default function Home() {
  ...
  return <main className="shell">
    ...
    <section className="intro compact-intro"><div><p className="eyebrow">DISCORD EVENT CALENDAR</p><h1>イベントを、<em>見つけやすく。</em></h1><p className="subcopy">きたろうのサーバーで共有されたイベントを、日付から探せます。</p></div></section>
